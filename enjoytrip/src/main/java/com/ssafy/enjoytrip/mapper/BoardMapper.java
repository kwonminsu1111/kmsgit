...
public interface BoardMapper {
	...
	// 내 프로필 취향 해시태그 문자열 목록 조회
	List<String> selectUserHashtags(@Param("userId") String userId);
	...
	// 좋아요 증감 로직
	int checkLikeExists(@Param("boardId") Long boardId, @Param("userId") String userId);
	int insertLike(@Param("boardId") Long boardId, @Param("userId") String userId);
	int deleteLike(@Param("boardId") Long boardId, @Param("userId") String userId);
