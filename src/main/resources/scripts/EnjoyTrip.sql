...
(7987002), (8199114), (8325573), (11018167), (11164998), 
(25042489), (25754890), (1890778114), (1416818260), (1262338999), (9113903);
...
(1, 1, 2, '제주도 3박 4일 꿀코스 공유합니다', '진짜 힐링 여행이었습니다. 꼭 가보세요.', '2026-05-01', '2026-05-03', 0, NOW(), 1, '제주'),
(2, 1, 1, '서울 경복궁 야간개장 후기', '야경이 정말 예쁩니다. 꼭 가보세요.', '2026-07-10', '2026-07-11', 15, NOW(), 5, '서울'),
(3, 2, NULL, '강릉 커피거리 추천', '안목해변에서 마시는 커피 최고예요.', '2026-09-05', '2026-09-05', 102, NOW(), 2, '강원'),
(4, 2, 4, '영덕 대게 맛집 1박 2일 테스트 코스', '영덕 최고!!!', '2025-07-15', '2025-07-17', 33, NOW(), 4, '경북');
